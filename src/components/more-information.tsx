...
export const MoreInformation = () => {
  return (
    <div className="my-40 md:flex md:items-center md:gap-4 max-w-230 mx-auto">
      <img src="/images/illustration-stay-productive.png" alt="image" className="mb-12 md:w-95" />
      
      <div>
        <h2 className="font-raleway font-bold mb-4">Stay productive, wherever you are</h2>
